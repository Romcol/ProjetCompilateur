 ...
 */
  ...
  static final public void retourne() throws ParseException {
    ...
    expression();
                                 fonction.retourne(stackExpression.getFinalType());
  }
  ...
  static final public void conditionnelle() throws ParseException {
    jj_consume_token(SI);
              conditionnelle.open();
    expression();
                              conditionnelle.checkExprType(stackExpression.getFinalType());
  ...
  static final public void iteration() throws ParseException {
    jj_consume_token(TANTQUE);
                   iteration.open();
    expression();
                      iteration.checkExprType(stackExpression.getFinalType());
  ...
  static final public void ecriture() throws ParseException {
    ...
    case ECRIRE:
      ...
      case 51:
        expression();
                                     yvm.ecrireValue(stackExpression.getFinalType());
        break;
      case chaine:
 ...
 */
  ...
  static final public void valeur() throws ParseException {
    ...
    case entier:
      jj_consume_token(entier);
                 stackExpression.pushInt(YakaTokenManager.entierLu);
      break;
    case ident:
      jj_consume_token(ident);
    ...
    case VRAI:
      jj_consume_token(VRAI);
                 stackExpression.pushBool(-1);
      break;
    case FAUX:
      jj_consume_token(FAUX);
                 stackExpression.pushBool(0);
      break;
    default:
      jj_la1[22] = jj_gen;
      jj_consume_token(-1);
  ...
  static final public void argumentsFonction() throws ParseException {
    ...
    case 51:
      expression();
                          appelFonction.initArguments(); appelFonction.addArgument(stackExpression.getFinalType());
      label_10:
      while (true) {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case 41:
        ...
        jj_consume_token(41);
        expression();
                           appelFonction.addArgument(stackExpression.getFinalType());
      }
      break;
    default:
      jj_la1[24] = jj_gen;
  ...
  static final public void opAdd() throws ParseException {
    ...
    case OU:
      jj_consume_token(OU);
                 stackExpression.pushOp(Operation.OR);
      break;
    default:
      jj_la1[26] = jj_gen;
      jj_consume_token(-1);
  ...
  static final public void opMul() throws ParseException {
    ...
    case ET:
      jj_consume_token(ET);
                 stackExpression.pushOp(Operation.AND);
      break;
    default:
      jj_la1[27] = jj_gen;
      jj_consume_token(-1);
  ...
  static final public void opNeg() throws ParseException {
    ...
    case NON:
      jj_consume_token(NON);
                 stackExpression.pushOp(Operation.NOT);
      break;
    default:
      jj_la1[28] = jj_gen;
      jj_consume_token(-1);
